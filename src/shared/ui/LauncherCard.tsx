...
/** DS LauncherCard — 핸드오프 components/navigation/LauncherCard.jsx 이식. 허브 진입 카드. */
...
export function LauncherCard({
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hover && active
          ? "var(--shadow-raised), 0 0 0 1.5px var(--violet-600), 0 8px 32px rgba(37,99,235,0.18)"
          : brand ? "var(--shadow-raised)" : "var(--shadow-card)",
    ...
    >
      {brand && <span style={{ position: "absolute", top: -46, right: -40, width: 150, height: 150, borderRadius: "50%", background: "rgba(56,189,248,0.14)" }} />}
      {locked && (
